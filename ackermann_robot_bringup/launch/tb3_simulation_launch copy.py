...
#         name='world',
#         default_value=  PathJoinSubstitution([FindPackageShare("ackermann_robot_bringup"), "worlds", "sim.world"]),
...
#     declared_arguments.append(declare_namespace_cmd)

#     declare_use_namespace_cmd = DeclareLaunchArgument(
#         'use_namespace',
#         default_value='false',
#         description='Whether to apply a namespace to the navigation stack')
#     declared_arguments.append(declare_use_namespace_cmd)

#     declare_slam_cmd = DeclareLaunchArgument(
#         'slam',
#         default_value='False',
#         description='Whether run a SLAM')
#     declared_arguments.append(declare_slam_cmd)
...
#                 [
#                     FindPackageShare("ackermann_robot_control"),
#                     "urdf",
...
#         [FindPackageShare("ackermann_robot_brungup"), "rviz", "nav2_default_view.rviz"]
#     )
...
#         PythonLaunchDescriptionSource(
#              PathJoinSubstitution([FindPackageShare("ackermann_robot_brungup"), "launch", "bringup_launch.py"])),
...
# #     bringup_dir = get_package_share_directory('ackermann_robot_bringup')
...
# #         default_value=os.path.join(bringup_dir, 'worlds', 'sim.world'),
# #         description='Full path to world model file to load')

# #     declare_robot_name_cmd = DeclareLaunchArgument(
# #         'robot_name',
# #         default_value='ackermann_robot',
